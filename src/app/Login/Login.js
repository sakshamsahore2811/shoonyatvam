  ...
  return (
    <div className={styles.container}>
      ...
      <div className={styles.mid}>
       ...
       <Link href="./addmedicine">  <Image src={box} alt="img" /></Link> 
       <Link href="./addmedicine">  <span>Place Order</span></Link> 
        </div>
        <div>
        <Link href="./myorders"> <Image src={circle} alt="img" /></Link>
        <Link href="./myorders"> <span>My Orders</span></Link>
        </div>
      </div>
